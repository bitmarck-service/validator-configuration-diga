...
<schema queryBinding="xslt2" xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <pattern>
        ...
        <rule context="ram:ApplicableHeaderTradeSettlement">
            <assert id="DRE0-AHTS-9" test="matches(normalize-space(ram:CreditorReferenceID[@schemeID = 'XR03']), '^\d{9}$')"
            >Eine DiGA-Rechnung muss das Institutionskennzeichen (IK) des Zahlungsempfängers mit exakt neun Ziffern enthalten.</assert>
            <assert id="DRE0-AHTS-10" test="normalize-space(ram:CreditorReferenceID[@schemeID = 'XR03']) != normalize-space(../ram:ApplicableHeaderTradeAgreement/ram:BuyerTradeParty/ram:ID[@schemeID = 'XR03'])"
